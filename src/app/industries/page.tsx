...
export default function IndustriesPage() {
  ...
  const whyFeatures = [
    {
      ...
      description: "A homebuilder, a property manager, and a commercial property owner all work differently. Before we quote, we learn your schedule, access rules, and budget cycle.",
    },
    {
      icon: faShieldHalved,
    ...
    },
    {
      ...
      title: "Gutters, Guards & Scheduling — One Vendor",
      description: "Whether your project needs multi-unit make-ready, new construction packages, or commercial gutters — we handle it under one roof.",
    },
  ];
  ...
  const localAreas = [
    ...
    { town: "Killeen", benefit: "Retail properties, apartments, and new construction.", badge: "" },
  ...
  const comparisonRows = [
    ...
    { feature: "Central Texas market knowledge", us: "✅ 13+ years in Waco", others: "❌ Out-of-area contractors" },
    ...
    { feature: "Lifetime Seam Warranty + 2-Year Labor", us: "✅ On every install", others: "❌ Limited or none" },
  ];

  const faq = [
    {
      question: "What types of organizations does FlowGuard Gutters work with?",
      answer: "We have dedicated experience with homebuilders, property management companies, and retail & commercial properties — in addition to residential gutter and guard services.",
    },
    {
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        ...
        subtitle="Gutter programs built for how your organization actually works — construction schedules, turnovers, and open dates, not a generic residential quote."
      />
      <TrustBar headline="Trusted by builders, property managers, and commercial clients across Central Texas since 2013" />
      ...
      <div className={styles.section}>
        <WhyChooseUs cityName="Waco" features={whyFeatures} title="Why Organizations Choose FlowGuard" />
      </div>
      <div className={styles.section}>
      ...
      <CTABanner
        headline="Need a Gutter & Guard Partner for Your Organization?"
        subline="Factory-certified crews. Portfolio-friendly scheduling. Call (254) 760-5500."
