...
// FlowGuard Gutters — Contact Page (unique build, not just a form import)
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 760-5500. We answer 7 days a week including evenings. For a genuine urgent gutter issue in Central Texas, call — don't wait on a form response.",
  },
  {
    question: 'How quickly can someone come out?',
    answer: "Free estimates are available most days; install dates follow product lead times. Same-week service is available most days during business hours. Evening and weekend emergency calls are dispatched within 1–2 hours. We'll give you an honest ETA when you call — not a 4-hour window.",
  },
  {
  ...
  {
    question: 'Do you work on commercial commercial gutters?',
    answer: 'Yes — light commercial strip centers, offices, and multi-unit properties are within our scope. Call to discuss your buildings and timeline.',
  },
  {
  ...
  },
  {
    ...
    answer: "Our specialist will tell you honestly after the estimate. If repair cost approaches replacement value or the system is failed, we'll recommend replacement — but we'll always show you the numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@flowguardgutters.com',
                  href:      'mailto:hello@flowguardgutters.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '900 N Valley Mills Dr, Waco TX 76710',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose FlowGuard</p>
              {[
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed FlowGuard electrician will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12547605500">(254) 760-5500</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 760-5500 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 760-5500"
        primaryLink="tel:+12547605500"
        secondaryText="Send a Text"
        secondaryLink="sms:+12547605500"
      />
