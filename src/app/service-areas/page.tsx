...
// FlowGuard Gutters — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full seamless gutters, guards, repair, downspouts, cleaning, and commercial systems across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full gutter and guard coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Gutter installs'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and Lifetime Seam Warranty + 2-Year Labor as every other area we cover.",
    highlights:  ['Flat-rate pricing', 'Lifetime Seam Warranty + 2-Year Labor', 'factory-certified'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable gutter and guard service for Bellmead residents and businesses. Gutter installs, repairs, and gutter installs — same-day when available.',
    highlights:  ['Residential & commercial', 'factory-certified installers', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential gutter and guard service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Gutter replacement and repair for McGregor homes and light industrial properties.',
    highlights:  ['Shop & residential', 'Gutter installs', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Gutter replacement, repair, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service gutter and guard coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial gutter and guard service.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial gutters in all areas?',
    answer: 'Yes — light commercial gutters for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, factory-certified installers, and a Lifetime Seam Warranty + 2-Year Labor — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12547605500" className={styles.heroCTAPrimary}>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12547605500" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12547605500" className={styles.unlistedCTA}>
            Call (254) 760-5500
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, Lifetime Seam Warranty + 2-Year Labor, no contracts ever."
