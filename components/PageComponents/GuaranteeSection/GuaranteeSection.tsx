...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  {
    icon: faShieldHalved,
    title: "Lifetime Seam Warranty + 2-Year Labor",
    description:
      "Every installation we perform is covered by Lifetime Seam Warranty + 2-Year Labor. If our workmanship fails within 10 years, we make it right.",
  },
  {
    icon: faRotateLeft,
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every gutter company in Central Texas makes promises. We back ours in writing — with flat-rate pricing, factory-certified installers, and a Lifetime Seam Warranty + 2-Year Labor on every install we touch.
          </p>
          <Link
            href={ctaLink}
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 700+ verified Google reviews</span>
          </div>
        </div>
