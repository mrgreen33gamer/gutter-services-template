...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Home Needs for Gutters & Guards',
  subheading = 'From full window replacements to entry doors and energy upgrades, FlowGuard handles it all — on time, on price.',
