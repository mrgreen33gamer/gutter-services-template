...
export default function NearbyAreasHero({
  ...
  const displayDesc     = description ??
    `FlowGuard Gutters provides fast, reliable gutter and guard service to ${cityName} and all surrounding communities. Licensed technicians, flat-rate pricing, 2-year warranty on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12547605500" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
