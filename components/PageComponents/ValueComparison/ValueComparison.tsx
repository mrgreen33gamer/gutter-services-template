...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: 'Lifetime Seam Warranty + 2-Year Labor',            us: true,  others: false },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'FlowGuard vs. The Other Guys' }: ValueComparisonProps) {
  return (
