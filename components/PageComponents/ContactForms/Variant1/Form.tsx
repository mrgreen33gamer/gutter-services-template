...
const SERVICES = [
  { icon: faFan,             label: 'Seamless Gutters' },
  { icon: faFire,            label: 'Gutter Guards' },
  { icon: faWrench,          label: 'Gutter Repair' },
  { icon: faFilter,          label: 'Downspouts & Drainage' },
  { icon: faThermometerHalf, label: 'Gutter Cleaning' },
  { icon: faWind,            label: 'Commercial Gutters' },
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A FlowGuard specialistnician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12547605500"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 760-5500', section: 'ContactForm-V1' })}>
                          Call (254) 760-5500
                        </a>
                      </span>
                    </div>
