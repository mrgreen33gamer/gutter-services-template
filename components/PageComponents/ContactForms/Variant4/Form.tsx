...
const SERVICES = [
  { icon: faFan,             label: 'Seamless Gutters',       sub: 'New install or full replacement' },
  { icon: faFire,            label: 'Gutter Guards',          sub: 'Keep leaves and debris out' },
  { icon: faWrench,          label: 'Gutter Repair',          sub: 'Leaks, sagging, damaged sections' },
  { icon: faFilter,          label: 'Downspouts & Drainage',  sub: 'Move water away from foundation' },
  { icon: faThermometerHalf, label: 'Gutter Cleaning',        sub: 'Cleanout, flush, and inspection' },
  { icon: faWind,            label: 'Commercial Gutters',     sub: 'Multi-unit and business properties' },
  { icon: faBolt,            label: 'Free Estimate',          sub: 'On-site quote, no obligation' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A FlowGuard specialist will reach out about your <strong>{selectedService}</strong> service.
                  </p>
