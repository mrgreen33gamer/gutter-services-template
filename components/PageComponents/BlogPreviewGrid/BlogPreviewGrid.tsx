...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Gutter Tips & Guides',
  subtitle    = 'Practical advice for Central Texas homeowners — seamless vs sectional, when guards pay off, and how often to clean.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
